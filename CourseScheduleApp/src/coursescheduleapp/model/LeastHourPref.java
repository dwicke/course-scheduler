...
public class LeastHourPref implements Preference {
	...
	private double getFitness(TimeDayCollection sched) {
		// TODO Auto-generated method stub
		double fitness = 0;
		double numHoursInWeek = sched.hoursInWeek();
		
			if (numHoursInWeek > 0)
			{
				fitness += (1 / numHoursInWeek);
			}
	...
	public void addPref(String pref) {
		// TODO Auto-generated method stub
		// Does nothing must implement for Preference
